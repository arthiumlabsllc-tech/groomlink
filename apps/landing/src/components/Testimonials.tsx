...
const testimonials = [
  ...
  },
  {
    ...
    location: 'Kumasi',
    content: 'Since joining GroomLink, my bookings have increased by 40%. The dashboard makes it so easy to manage my shop and staff schedules.',
    rating: 5,
    avatar: 'Y',
  },
  {
    ...
    role: 'Salon Owner',
    location: 'Takoradi',
    content: 'The analytics feature helps me understand my peak hours. I\'ve been able to optimize my staffing and increase revenue significantly.',
    rating: 5,
    avatar: 'E',
  },
  {
    ...
    role: 'Regular Customer',
    location: 'Cape Coast',
    content: 'Love the Mobile Money payment option! So convenient. And the reminder notifications mean I never miss an appointment anymore.',
    rating: 5,
    avatar: 'K',
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Quote className="w-8 h-8 text-ghana-gold mb-4 opacity-50" />
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-ghana-gold rounded-full flex items-center justify-center text-ghana-black font-bold">
                  {testimonial.avatar}
                </div>
                <div>
