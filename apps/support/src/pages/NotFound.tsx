      ...
      <div className="text-center max-w-md">
        <div className="mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gray-50 dark:bg-gray-800 mb-6">
            <Icon name="explore_off" size={64} className="text-gray-300 dark:text-gray-600" />
          </div>
          <h1 className="text-8xl font-bold text-gradient mb-4 font-heading">404</h1>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2 font-heading">Page Not Found</h2>
